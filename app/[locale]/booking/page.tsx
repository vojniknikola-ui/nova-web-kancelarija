  ...
  return (
    <div className="bg-gradient-to-b from-white to-slate-50 py-16">
      <div className="container mx-auto grid gap-12 px-4 md:grid-cols-2">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-secondary">Booking</p>
          <h1 className="mt-4 text-4xl font-serif text-primary">{dictionary.booking.heading}</h1>
          <p className="mt-4 text-slate-600">{dictionary.booking.subheading}</p>
          <div className="mt-8 space-y-4 text-sm text-slate-600">
            <p>
              <strong>{dictionary.booking.detailsTitle}</strong>
        ...
        <div className="rounded-3xl bg-white p-8 shadow-xl">
          <h2 className="text-2xl font-serif text-primary">{dictionary.booking.formTitle}</h2>
